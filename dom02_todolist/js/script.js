...
var renderTodos = function () {
  //   console.log(todos);
  //   console.log(formUpdateID);
  var html = todos
    .map(function (todo, index) {
      var value = formUpdateID.find(function (e) {
...
todoForm.addEventListener("submit", function (event) {
  ...
  var todo = {
    // name: this.querySelector(".todo-input").value,
    name: doName,
    completed: false,
  };
  todos.push(todo);
...
var showFormUPdate = function (todoEl) {
  ...
  var formList = todoList.querySelectorAll(".todo-form");
    ...
    if (todoForm.dataset.index === index) {
      ...
      todoForm
        ...
        .addEventListener("change", function () {
          value = this.value;
          var indexUPdate = formUpdateID.findIndex(function (e) {
            return +e.index === +index;
          });
          // console.log(indexUPdate);
          if (indexUPdate !== -1) {
            formUpdateID[indexUPdate].value = value;
          }
        });
      todoForm.addEventListener("submit", function (e) {
        e.preventDefault();
        todo[index].name = value;
        todoForm.outerHTML = getTodoHTML(todo[index], index);
      });
    }
  ...
  //them index vao mang form update
